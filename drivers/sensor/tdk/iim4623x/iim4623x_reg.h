...
/*
 * Every packet contains a preamble with a header, message lenght, and type.
 *
...
struct iim4623x_pck_strm_payload {
	/* Combined sample status and sensor status */
	struct {
		uint8_t _reserved: 7;
	...
	uint64_t timestamp; /* TODO: datasheet mentions ascii stamp, do we need union? */
...
enum iim4623x_cmd_error_code {
	IIM4623X_CMD_ACK = 0x00,
	IIM4623X_CMD_NACK = 0x01,
	IIM4623X_CMD_E_WRITE = 0x02,
	IIM4623X_CMD_E_READ = 0x03,
	IIM4623X_CMD_E_INVAL = 0x04,
	/* Reserved */
	IIM4623X_CMD_E_WRITE_FLASH = 0x06,
	IIM4623X_CMD_E_READ_FLASH = 0x07,
	/* Reserved */
	/* Reserved */
	IIM4623X_CMD_E_WRITE_USER = 0x0a,
	IIM4623X_CMD_E_READ_USER = 0x0b,
	IIM4623X_CMD_E_FLASH_ENDURANCE = 0x0c,
	/* Reserved ... */
};
...
#define IIM4623X_SEL_OUT_DATA_D_ANG BIT(3)
